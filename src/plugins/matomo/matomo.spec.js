...
describe("pugin.matomo", () => {
  const matomo = {
    url: "https://stats.devmastery/matomo/",
    id: 2,
  }
  ...
  //     url: '/rss-opened',
  //   })
  //   expect(html).toEqual('<img src="https://stats.devmastery/matomo/matomo.php?idsite=2&amp;rec=1&amp;bots=1&amp;url=%2Frss-opened&amp;_rcn=blog" alt="" style="border:0;">')
  // })
...
if (!((window.navigator && window.navigator['doNotTrack'] == 1) || (document.cookie && document.cookie.indexOf(disableStr + '=true') !== -1))) {    
  ...
  (function() {
    var u="https://stats.devmastery/matomo/";
...
</script><noscript><img src="https://stats.devmastery/matomo/matomo.php?idsite=2&amp;rec=1" style="border:0;" alt=""></noscript>`)
  })
  ...
  it("should change url", () => {
    ...
    expect(handleURL("https://devmastery/imprint")).toBe(
      "https://devmastery/imprint?pk_campaign=a&pk_kwd=b"
    )
  })
})

...
export function meta(pluginOpt = {}) {
  ...
  // generator:   Hostic :)
  // twitter:     handle like @devmastery (site and creator)
  ...
  return {
    ...
    middleware: async (ctx, next) => {
      ...
      let opt = Object.assign({}, pluginOpt, ctx.meta || {}, ctx)
      ...
      if (opt.keywords) {
        ...
        head.appendChild(
          <meta name="keywords" property="og:keywords" content={opt.keywords} />
        )
      }
      ...
      // Generator, Type
      {
        let {
          type = "website",
          generator = "Hostic, https://github.com/devmastery/hostic/",
        } = opt
